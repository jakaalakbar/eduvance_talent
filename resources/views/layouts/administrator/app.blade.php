...
<head>
    ...
    <title>Edutalent</title>
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/administrator/css/styles.min.css') }}" />
...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="./index.html" class="text-nowrap logo-img">
                        <img src="{{ asset('assets/administrator/images/logos/logo-light.svg') }}" alt="" />
                    </a>
                    ...
                    <div class="unlimited-access hide-menu bg-primary-subtle position-relative mb-7 mt-7 rounded-3">
                        <div class="d-flex">
                            ...
                            <div class="unlimited-access-img">
                                <img src="{{ asset('assets/administrator/images/backgrounds/rocket.png') }}"
                                    alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    ...
                                    <img src="{{ asset('assets/administrator/images/profile/user-1.jpg') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <img src="{{ asset('assets/administrator/images/backgrounds/product-tip.png') }}"
                    ...
                    <div class="col-lg-4">
                        <div class="card overflow-hidden hover-img">
                            <div class="position-relative">
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('assets/administrator/images/blog/blog-img1.jpg') }}"
                                ...
                                <span
                                    ...
                                    min Read</span>
                                <img src="{{ asset('assets/administrator/images/profile/user-3.jpg') }}"
                                    alt="matdash-img"
                    ...
                    <div class="col-lg-4">
                        <div class="card overflow-hidden hover-img">
                            <div class="position-relative">
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('assets/administrator/images/blog/blog-img2.jpg') }}"
                                        class="card-img-top" alt="matdash-img">
                                </a>
                                <span
                                    class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                                    min Read</span>
                                <img src="{{ asset('assets/administrator/images/profile/user-2.jpg') }}"
                                    alt="matdash-img"
                                    class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9"
                                    width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Georgeanna Ramero">
                    ...
                    <div class="col-lg-4">
                        <div class="card overflow-hidden hover-img">
                            <div class="position-relative">
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('assets/administrator/images/blog/blog-img3.jpg') }}"
                                        class="card-img-top" alt="matdash-img">
                                </a>
                                <span
                                    class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
        ...
        <script src="{{ asset('assets/administrator/libs/apexcharts/dist/apexcharts.min.js') }}"></script>
        <script src="{{ asset('assets/administrator/libs/simplebar/dist/simplebar.js') }}"></script>
        <script src="{{ asset('assets/administrator/js/sidebarmenu.js') }}"></script>
        <script src="{{ asset('assets/administrator/js/app.min.js') }}"></script>
        <script src="{{ asset('assets/administrator/js/dashboard.js') }}"></script>
